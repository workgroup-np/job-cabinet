        ...
        <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?>
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?>
                ...
                <div class="cs-heading-area">
                    <h5><?php esc_html_e('Editor Options', 'jobcareer'); ?></h5>
                ...
                <div class="cs-pbwp-content">
					...
					<?php
                        ...
                        <?php
                        $cs_opt_array = array(
                            'name' => esc_html__('Enter Description', 'jobcareer'),
                            'desc' => '',
                            'hint_text' => esc_html__("Enter your description here", 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
                                'std' => esc_textarea($flex_editor_text),
                                'cust_id' => '',
                                'classes' => 'textarea',
