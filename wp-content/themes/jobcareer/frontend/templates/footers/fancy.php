                ...
                if (isset($cs_footer_widget) and $cs_footer_widget == 'on') {
                    if ($cssidebar == true) {
                        ...
                        foreach ($cs_footer_sidebar['footer_sidebar'] as $footer_sidebar_var => $footer_sidebar_val) {
                            ...
                            $footer_sidebar_id = strtolower(str_replace(' ', '-', $footer_sidebar_val));
                            if (is_active_sidebar($footer_sidebar_id)) {
                                echo ' <div class="col-lg-' . $cs_footer_sidebar_width . ' col-md-' . $cs_footer_sidebar_width . ' col-sm-' . $cs_footer_sidebar_width . ' col-xs-12">';
                                if (!function_exists('dynamic_sidebar') || !dynamic_sidebar($footer_sidebar_id)) : endif;
                                echo ' </div>';
                            }
                            $i++;
                        }
                        $copyright_class = 'col-lg-4 col-md-4 col-sm-4 col-xs-12';
                    }
                }
                ?> 
                <div class="<?php echo esc_html($copyright_class); ?> cs-copyright" style="background-color:<?php echo esc_html($footer_background_color); ?>;">
                    <div class="cs-copyright-area">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="widget-title">
                                    <h5><?php echo esc_html(__('Follow us', 'jobcareer')); ?></h5>
                                </div>
                                <?php
